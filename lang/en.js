...
theUILang.autodlTitle30 = "Name of folder, macros are allowed, eg. /home/YOURNAME/downloads/$(month)$(day)/$(TrackerShort)";
...
theUILang.autodlTitle44 = "User agent used when checking if the downloaded torrent is registered on the tracker.";
theUILang.autodlTitle45 = "Peer id sent to the tracker when checking if the torrent is registered. Must be exactly 20 characters.";
theUILang.autodlTitle46 = "Retry downloads if an error occurs but stop after this timeout in seconds is reached.";
theUILang.autodlTitle47 = "Default is 3, set it to 5 for debug output, and -1 to turn off all messages.";
theUILang.autodlTitle48 = "Extra debug output";
...
theUILang.autodlHint30 = "Eg. /home/YOURNAME/$(month)$(day)";
